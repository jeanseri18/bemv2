                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-5 col-md-12 col-12">
                                    <div class="mb-5 mb-lg-0">
                                        ...
                                        Formation par
                                            <u class="text-warning"><span class="text-primary">catalogue</span></u>
                                        </h2>
                                        <p class="mb-5 lead">
            ...
            <div class="offset-xl-1 col-xl-10 col-md-12 col-12">
                <div class="row text-center">
                    <div class="col-md-12 px-lg-8 mb-8 mt-6">
                        <!-- text -->
                        <!-- heading -->
                        <h2 class="h1 fw-bold mt-3" style="color:white">Nos parcours de formation</h2>
                        <!-- text -->
                        <p class="mb-0 fs-4" style="color:white">Nos formations catalogue offrent une gamme de programmes standards, conçus par des experts du domaine pour répondre aux besoins communs des entreprises en matière de développement des compétences.</p>
                    </div>
                </div>
                <div class="row gy-4">
