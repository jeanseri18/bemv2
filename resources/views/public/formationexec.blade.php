        ...
        <div class="row">
            ...
            <div class="col-xl-12  col-md-12 col-12">
                <div class="row gy-4 gy-xl-0">
                    <div class="col-xl-3 col-md-6 col-12 " style="height:200px">
                        <div class="card card-lift h-100 text-center text-lg-start bg-primary text-white ">
                            ...
                            <div class="card-body pt-2 text-center ">
                                <h3><a class="text-white text-center" href="#!">Gouvernance</a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6 col-12" style="height:200px">
                        <div class="card card-lift h-100 text-center text-lg-start bg-primary text-white">
                            ...
                            <div class="card-body pt-2  text-center">
                                <h3><a class="text-white text-center" href="#!">leadership & Management</a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6 col-12" style="height:200px">
                        <div class="card card-lift h-100 text-center text-lg-start bg-primary text-white">
                            ...
                            <div class="card-body pt-2  text-center">
                                <h3><a class="text-white text-center" href="#!">Coaching</a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6 col-12" style="height:200px">
                        <div class="card card-lift h-100 text-center text-lg-start bg-primary text-white">
                            ...
                            <div class="card-body pt-2  text-center">
                                <h3><a class="text-white text-center" href="#!">E-learning</a></h3>
                            </div>
                        </div>
                    </div>
                </div>
